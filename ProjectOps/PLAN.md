...
| P-012 | Convertir self-modification en transacción segura y recuperable | EN_EJECUCIÓN | integrado/revalidado E3 en `main fe845184...`; P-013 evidence/correlation es el gate restante antes de cierre completo | plan/P-012.md |
| P-013 | Unificar Observability, Audit y Evidence Fabric | PLANIFICADO | P-008 + P-009; se extiende durante la campaña y aporta evidence/correlation requerida por P-012 | plan/P-013.md |
...
11. **Broad knowledge != broad prompt**: persistent universe amplio; working set activado por relevancia/causalidad/uncertainty/dependencies/value-of-information/context cost.
...
P-012 implementó y gateó su source transaccional final: journal/lease SQLite v17, candidate Git worktree aislado, verification previa, candidate commit exacto, activation compare-and-swap, post-probe/rollback/recovery causal y convergencia de edit/revert/reset/pull/write-to-runtime. La reauditoría final separó direct-write protection de verdadera immutability: código crítico y dependencias pueden evolucionar en candidate verificado, `edit_own_file` soporta cambios multiarchivo atómicos y se retiró el threshold arbitrario de 100 KB además de `10/hour`/`20/hour` como falsas safety authorities. Source limpio `84399f491856ca8a6195bbb8c08940ab8201f5d8`; exact-head de rama con el mismo tree `991650ce5deb7e170a99647bf5246982bc7cd37a`: CI `34925701691` + ProjectOps `34925701696` SUCCESS. Exact PR head `1c9eabe430893c2be145c83441b8371b65af285e`: CI `34926226279` + ProjectOps `34926226266` SUCCESS. Squash merge a `main`: `fe845184fce48c65032f8521ecd0bdfa42e04b77`; exact merged main CI `34926393562` + ProjectOps Integrity `34926393570` SUCCESS.

P-012 sigue `EN_EJECUCIÓN` sólo porque su propia Definition of Done exige evidence/correlation transversal P-013 antes del cierre completo. No queda integración ni revalidación P-012 pendiente y no debe reabrirse su arquitectura salvo defecto reproducible o incompatibilidad demostrada.
...
`P-013 — aportar Observability/Audit/Evidence correlation transversal sobre el main P-012 verde; sólo después puede cerrarse P-012 completo`. Antes de esa transición, cualquier intervención de proceso abierta debe reconciliarse y cerrarse conforme a `AGENTS.md`.