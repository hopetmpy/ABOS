...
# ABOS — Database backup/restore tooling
...
Examples:
  $(basename "$0") backup ./data/abos.db
  $(basename "$0") backup ./data/abos.db ./backups/abos-2024.db
  $(basename "$0") restore ./backups/abos-2024.db ./data/abos.db
  $(basename "$0") verify ./data/abos.db
EOF
  exit 1
}
